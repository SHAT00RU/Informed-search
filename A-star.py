...
# A* Search to solve cryptarithm problem
def cryptarithmetic_astar(word1, word2, operation, result):
...
# A* search solution
solution = cryptarithmetic_astar(word1, word2, operation, result)
print("Solution using A*:", solution)
